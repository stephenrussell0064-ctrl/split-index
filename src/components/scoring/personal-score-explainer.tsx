      ...
      >
        ...
        >
          ...
          <ScoreTrendChart
            ...
            seriesKey={sport}
            metric="personal"
            heading="Your last {n} sessions in this sport"
            seriesName="Your score against yourself"
            referenceAt={CENTRE_DISPLAY}
            footnote="The dashed line is your normal. It moves with you, so a run of sessions above it is a block of form outrunning its own baseline."
          />
