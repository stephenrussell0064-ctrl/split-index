...
function renderCardio(result: Partial<CardioResult>): string {
  const base: CardioResult = {
    score: 620,
    paceScore: 620,
    // The two-score fields. `populationScore` mirrors `score`, as the engine
    // writes it; the personal side is null because this fixture is one session
    // with no history behind it, which is exactly when it is null in life.
    populationScore: 620,
    personalScore: null,
    personal: null,
