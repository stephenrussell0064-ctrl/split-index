...
export function LegalBackLink() {
  ...
  // navigateBack needs the current path: it maps a legal page back to its own
  // zone home rather than to whatever happened to precede it.
  ...
  return (
    <button
      type="button"
      onClick={() => (inApp ? router.push("/settings") : navigateBack(router, pathname))}
