...
export const COMMON_EXERCISES: ExerciseDefinition[] = [
  ...
  { name: "Iso-Lateral Chest Press", muscle: "Chest", category: "chest", kind: "compound" },
  { name: "Iso-Lateral Incline Press", muscle: "Chest", category: "chest", kind: "compound" },
  { name: "Iso-Lateral Decline Press", muscle: "Chest", category: "chest", kind: "compound" },
  ...
  { name: "Iso-Lateral Row", muscle: "Back", category: "back", kind: "compound" },
  { name: "Iso-Lateral High Row", muscle: "Back", category: "back", kind: "compound" },
  { name: "Iso-Lateral Low Row", muscle: "Back", category: "back", kind: "compound" },
  { name: "Iso-Lateral Wide Pulldown", muscle: "Back", category: "back", kind: "compound" },
  { name: "Iso-Lateral Front Pulldown", muscle: "Back", category: "back", kind: "compound" },
  // Back — accessory
  ...
  { name: "Iso-Lateral Leg Press", muscle: "Quads", category: "legs", kind: "compound" },
  ...
  { name: "Iso-Lateral Leg Extension", muscle: "Quads", category: "legs", kind: "accessory" },
  ...
  { name: "Iso-Lateral Leg Curl", muscle: "Hamstrings", category: "legs", kind: "accessory" },
  ...
  { name: "Iso-Lateral Shoulder Press", muscle: "Shoulders", category: "shoulders", kind: "compound" },
  ...
  { name: "Weighted Muscle Up", muscle: "Back", category: "back", kind: "compound" },
  { name: "Ring Dip", muscle: "Chest", category: "chest", kind: "compound" },
  { name: "Weighted Ring Dip", muscle: "Chest", category: "chest", kind: "compound" },
